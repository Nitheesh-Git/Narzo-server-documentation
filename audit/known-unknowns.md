...
|---|---|---|---|
| Public Internet exposure | **UNKNOWN** | LAN and tailnet paths are proven; global IPv6 addresses exist on Wi-Fi | Router/AP IPv4 port-forward, IPv6 inbound-firewall, UPnP/NAT-PMP, and Tailscale Funnel review |
